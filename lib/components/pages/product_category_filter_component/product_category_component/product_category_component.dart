...
class ProductCategoryComponent implements OnActivate {
  ...
  void onActivate(RouterState previous, RouterState current) {
    ...
    if (model == null) {
      products = _productService.cachedModels.values.where((p) => !p.sub_only && p.sub_product_ids.isEmpty);      
      ...
      description = model.phrases[languageService.currentShortLocale]?.description;
    }
  }
